...
METRIC_NAMES = {
    ...
    "total_catalog_size_GB": ("dune_rucio_catalog_size_gb", ""),
    ...
    "total_missing_size_GB": ("dune_rucio_missing_size_gb", ""),
    "total_size_mismatch_file_count": ("dune_rucio_size_mismatch_files_total", ""),
    "total_size_mismatch_size_GB": ("dune_rucio_size_mismatch_size_gb", ""),
    "total_checksum_mismatch_file_count": ("dune_rucio_checksum_mismatch_files_total", ""),
    "total_checksum_mismatch_size_GB": ("dune_rucio_checksum_mismatch_size_gb", ""),
